...
const I18N = {
  en: {
    ...
    'page.dashboard_eyebrow': 'Login required', 'page.dashboard_heading': 'Farm dashboard',
  ...
  hi: {
    ...
    'page.dashboard_eyebrow': 'लॉगिन आवश्यक', 'page.dashboard_heading': 'फार्म डैशबोर्ड',
  ...
  kn: {
    ...
    'page.dashboard_eyebrow': 'ಲಾಗಿನ್ ಅಗತ್ಯ', 'page.dashboard_heading': 'ಫಾರ್ಮ್ ಡ್ಯಾಶ್‌ಬೋರ್ಡ್',
  ...
  mr: {
    ...
    'page.dashboard_eyebrow': 'लॉगिन आवश्यक', 'page.dashboard_heading': 'फार्म डॅशबोर्ड',
  ...
  ta: {
    ...
    'page.dashboard_eyebrow': 'உள்நுழைவு தேவை', 'page.dashboard_heading': 'பண்ணை டாஷ்போர்டு',
  ...
  te: {
    ...
    'page.dashboard_eyebrow': 'లాగిన్ అవసరం', 'page.dashboard_heading': 'ఫార్మ్ డాష్‌బోర్డ్',
