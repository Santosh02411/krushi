...
DISEASE_REFERENCE = {
    ...
    "onion": [
        {"disease": "Purple Blotch",
         "symptoms": ["small water-soaked spots that turn purple-brown with concentric rings on leaves",
                      "leaf tip dieback"],
         "cause": "Fungal (Alternaria porri), favored by warm, humid weather and overhead irrigation.",
         "treatment": "Avoid overhead irrigation late in the day; remove infected leaves; ensure good field drainage.",
         "recommended_fungicide": "Mancozeb or Chlorothalonil spray at first sign of infection."},
        {"disease": "Downy Mildew",
         "symptoms": ["pale yellow-green patches on leaves", "greyish-violet fuzzy fungal growth in humid weather"],
         "cause": "Fungal-like oomycete (Peronospora destructor), favored by cool, humid, cloudy weather.",
         "treatment": "Improve airflow and drainage; avoid dense planting.",
         "recommended_fungicide": "Metalaxyl + Mancozeb spray."},
    ],
    "groundnut": [
        {"disease": "Tikka Leaf Spot",
         "symptoms": ["small circular brown-black spots with a yellow halo on leaves",
                      "premature leaf drop in severe cases"],
         "cause": "Fungal (Cercospora arachidicola / Cercosporidium personatum), favored by humid weather.",
         "treatment": "Remove crop debris after harvest; rotate with non-legume crops.",
         "recommended_fungicide": "Chlorothalonil or Mancozeb spray at first sign of infection."},
        {"disease": "Collar Rot",
         "symptoms": ["rotting/girdling of the stem at soil level", "sudden wilting of seedlings"],
         "cause": "Fungal (Aspergillus niger), favored by high soil temperature and moisture stress at germination.",
         "treatment": "Use disease-free, well-dried seed; avoid deep sowing and waterlogging.",
         "recommended_fungicide": "Carbendazim or Thiram seed treatment before sowing."},
    ],
    "soybean": [
        {"disease": "Yellow Mosaic Virus",
         "symptoms": ["bright yellow mosaic patches on leaves", "stunted growth and reduced pod formation"],
         "cause": "Viral, transmitted by whitefly.",
         "treatment": "Control whitefly population; remove infected plants early; use tolerant varieties.",
         "recommended_fungicide": "Not fungal — whitefly control (e.g. Imidacloprid) limits spread."},
        {"disease": "Rust",
         "symptoms": ["small reddish-brown pustules mainly on the leaf undersurface"],
         "cause": "Fungal (Phakopsora pachyrhizi), spreads fast in warm, humid weather.",
         "treatment": "Monitor closely during humid weeks; avoid dense canopy.",
         "recommended_fungicide": "Tebuconazole or Propiconazole spray at first sign of infection."},
    ],
    "sunflower": [
        {"disease": "Alternaria Leaf Blight",
         "symptoms": ["dark brown spots with concentric rings on leaves", "spots enlarging and merging in severe cases"],
         "cause": "Fungal (Alternaria helianthi), favored by warm, humid weather.",
         "treatment": "Remove infected debris after harvest; avoid dense planting for better airflow.",
         "recommended_fungicide": "Mancozeb or Chlorothalonil spray."},
        {"disease": "Downy Mildew",
         "symptoms": ["pale green-yellow patches on upper leaf surface", "white fungal growth on the underside"],
         "cause": "Fungal-like oomycete (Plasmopara halstedii), favored by cool, wet soil at germination.",
         "treatment": "Use treated seed; avoid waterlogged fields at sowing.",
         "recommended_fungicide": "Metalaxyl seed treatment before sowing."},
    ],
    "mustard": [
        {"disease": "Alternaria Blight",
         "symptoms": ["circular dark brown-black spots with concentric rings on leaves and pods"],
         "cause": "Fungal (Alternaria brassicae), favored by humid weather and dew.",
         "treatment": "Avoid dense sowing; remove infected debris after harvest.",
         "recommended_fungicide": "Mancozeb or Iprodione spray at first sign of infection."},
        {"disease": "White Rust",
         "symptoms": ["white, shiny, raised pustules on the leaf undersurface", "distortion of flowering shoots"],
         "cause": "Fungal-like oomycete (Albugo candida), favored by cool, humid weather.",
         "treatment": "Remove and destroy infected plants; avoid overhead irrigation in cool weather.",
         "recommended_fungicide": "Metalaxyl + Mancozeb spray."},
    ],
    "chilli": [
        {"disease": "Anthracnose (Fruit Rot)",
         "symptoms": ["sunken, dark circular spots on ripening fruit", "concentric rings of black dots inside the spot"],
         "cause": "Fungal (Colletotrichum spp.), favored by warm, humid weather near fruit ripening.",
         "treatment": "Remove and destroy infected fruit; avoid overhead irrigation; ensure good airflow.",
         "recommended_fungicide": "Carbendazim or Mancozeb spray."},
        {"disease": "Leaf Curl Virus",
         "symptoms": ["upward curling and crinkling of leaves", "stunted, bushy growth with reduced fruiting"],
         "cause": "Viral, transmitted by whitefly.",
         "treatment": "Control whitefly population; remove infected plants early; use tolerant varieties.",
         "recommended_fungicide": "Not fungal — whitefly control (e.g. Imidacloprid) limits spread."},
    ],
    "turmeric": [
        {"disease": "Leaf Blotch",
         "symptoms": ["small oval brown spots with yellow halo on leaves, merging in severe cases"],
         "cause": "Fungal (Taphrina maculans), favored by warm, humid weather.",
         "treatment": "Avoid dense planting; remove severely infected leaves.",
         "recommended_fungicide": "Mancozeb or Copper oxychloride spray."},
        {"disease": "Rhizome Rot",
         "symptoms": ["yellowing and drying of leaves from the tip downward", "soft, rotting rhizomes with a foul smell"],
         "cause": "Fungal/bacterial complex, favored by waterlogging.",
         "treatment": "Ensure good field drainage; use disease-free rhizomes for planting; avoid waterlogging.",
         "recommended_fungicide": "Mancozeb or Metalaxyl rhizome treatment before planting."},
    ],
    "ginger": [
        {"disease": "Rhizome Rot (Soft Rot)",
         "symptoms": ["yellowing and drooping of pseudostems", "water-soaked, rotting rhizomes with foul smell"],
         "cause": "Fungal-like oomycete (Pythium spp.) often with bacterial soft rot, favored by waterlogging.",
         "treatment": "Ensure raised beds and good drainage; use disease-free, treated rhizomes for planting.",
         "recommended_fungicide": "Metalaxyl + Mancozeb rhizome treatment before planting."},
        {"disease": "Leaf Spot",
         "symptoms": ["small water-soaked spots turning greyish-white with a brown margin on leaves"],
         "cause": "Fungal (Phyllosticta zingiberi), favored by warm, humid weather.",
         "treatment": "Remove infected leaves; avoid dense planting for better airflow.",
         "recommended_fungicide": "Mancozeb or Copper oxychloride spray."},
    ],
    "garlic": [
        {"disease": "Purple Blotch",
        ...
        {"disease": "Stemphylium Blight",
         "symptoms": ["small yellow-brown streaks that enlarge and turn the leaf tip blighted"],
         "cause": "Fungal (Stemphylium vesicarium), favored by humid weather.",
         "treatment": "Avoid overhead irrigation; ensure good airflow between rows.",
         "recommended_fungicide": "Mancozeb spray at first sign of infection."},
    ],
    "apple": [
        {"disease": "Apple Scab",
         "symptoms": ["olive-green to black velvety spots on leaves and fruit", "premature leaf drop in severe cases"],
         "cause": "Fungal (Venturia inaequalis), favored by cool, wet spring weather.",
         "treatment": "Prune for better airflow; remove and destroy fallen infected leaves.",
         "recommended_fungicide": "Mancozeb or Captan spray from early leaf emergence."},
        {"disease": "Powdery Mildew",
         "symptoms": ["white powdery coating on young leaves and shoots", "curling and stunting of new growth"],
         "cause": "Fungal (Podosphaera leucotricha), favored by warm days and cool nights.",
         "treatment": "Prune infected shoots in dormant season; ensure good airflow.",
         "recommended_fungicide": "Sulfur or Myclobutanil spray."},
    ],
    "barley": [
        {"disease": "Stripe Rust",
         "symptoms": ["yellow-orange powdery stripes running along leaf veins"],
